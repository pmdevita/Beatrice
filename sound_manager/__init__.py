...
class SoundManager(commands.Cog):
    def __init__(self, bot):
        ...
        self.pipe.send({'command': 'play', 'voice_channel': 561259215411347468, 'audio_channel': 'notifications', 'audio_file': 'assets/inhale_a_car.opus', 'override': False})
    ...
    async def play(self, voice_channel: nextcord.VoiceChannel, audio_channel, audio_file, override=False):
        """
